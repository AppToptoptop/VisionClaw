...
struct CameraAccessApp: App {
  ...
  init() {
    // Configure Gemini and OpenClaw credentials via setup UI or a local-only debug file.
    // Never commit real API keys or gateway tokens in the sample app source.
